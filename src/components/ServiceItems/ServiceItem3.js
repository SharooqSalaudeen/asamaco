...
export default function ServiceItem3() {
  return (
      ...
      <div className="services-detail-content">
        <div className="ot-heading ">
          ...
          <h2 className="main-heading">
            Custom: We don’t Use Fakes and Work Only
            <br /> with Original Brands
          </h2>
        </div>
        <p>
        ...
        >
          <SwiperSlide>
            <img src="/images/service-list/3/service-silder5.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/3/service-silder6.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/3/service-silder5.jpg" alt="" />
          </SwiperSlide>
        ...
        <img
          src="/images/service-list/3/image1-service3.jpg"
