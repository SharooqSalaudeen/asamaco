...
export default function ServiceItem5() {
  return (
      ...
      <div className="services-detail-content">
        <div className="ot-heading ">
          ...
          <h2 className="main-heading">
            Creating: We will Help You to Get the Result
            <br /> You Dreamed of
          </h2>
        </div>
        <p>
        ...
        >
          <SwiperSlide>
            <img src="/images/service-list/5/service-silder9.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/5/service-silder10.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/5/service-silder9.jpg" alt="" />
          </SwiperSlide>
        ...
        <img
          src="/images/service-list/5/image1-service5.jpg"
