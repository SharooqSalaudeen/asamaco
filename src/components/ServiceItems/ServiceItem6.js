...
export default function ServiceItem6() {
  return (
      ...
      <div className="services-detail-content">
        <div className="ot-heading ">
          ...
          <h2 className="main-heading">
            Customer: We Combine Architecture, Interior
            <br /> Design, Subject Design
          </h2>
        </div>
        <p>
        ...
        >
          <SwiperSlide>
            <img src="/images/service-list/6/service-silder11.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/6/service-silder12.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/6/service-silder11.jpg" alt="" />
          </SwiperSlide>
        ...
        <img
          src="/images/service-list/6/image1-service6.jpg"
