...
export default function ServiceItem1() {
  return (
      ...
      <div className="services-detail-content">
        <div className="ot-heading ">
          ...
          <h2 className="main-heading">
            Design: All Kinds of Buildings in Chematic or
            <br /> Working Design
          </h2>
        </div>
        <p>
        ...
        >
          <SwiperSlide>
            <img src="/images/service-list/1/service-silder1.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/1/service-silder2.jpg" alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/service-list/1/service-silder1.jpg" alt="" />
          </SwiperSlide>
        ...
        <img
          src="/images/service-list/1/image1-service1.jpg"
