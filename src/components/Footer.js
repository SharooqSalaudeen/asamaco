...
export default function Footer() {
  ...
  return (
    <>
      <footer id="site-footer" className="site-footer" style={{ zIndex: "99" }}>
          ...
          <div className="row">
            <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4 mb-xl-0">
              <div className="widget-footer">
                ...
                />
                <p>
                  We provides a full range of architectural design,
                  construction, interior design and contruction machienaries.
                </p>
              ...
              <div className="widget-footer">
                ...
                <ul className="footer-list">
                  ...
                  <li className="footer-list-item">
                    ...
                    <span className="list-item-text">info@asamaco.com</span>
                  </li>
                  {/* <li className="footer-list-item">
                    <span className="list-item-icon">
              ...
              <div className="widget-footer footer-widget-subcribe">
                ...
                >
                  <div className="mc4wp-form-fields">
                    ...
                    {subscribed ? <p> You have subscribed</p> : null}
                  </div>
                </form>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-7 col-md-12 mb-4 mb-lg-0">
              <p>
                Copyright © 2020 by{" "}
                <a className="text-light" href="https://asamaco.com">
